...
# Bug 2: Approve checkbox not working ************************************************************************************************************ (InputCheckbox)
...
# Bug 3: Cannot select _All Employees_ after selecting an employee ********************************************************************************************************* (AppContextProvider)
...
# Bug 6: View more button not working as expected  ************************************************************************************************************ (app.tsx)
